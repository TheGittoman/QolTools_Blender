...
keys = {'MIRROR':[{'label': 'Mirror x', 'keymap': 'Mesh', 'idname': 'mesh.mirror', 'type': 'X', 'value': 'PRESS', "alt": True, "shift": True, "properties": [( "direction","POSITIVE_X" )]},
        ...
        "QOL":[{'label': 'Select linked', 'keymap': 'Mesh', 'idname': 'mesh.select_linked_pick', 'type': 'LEFTMOUSE', 'value': 'DOUBLE_CLICK', "alt": False, "ctrl": False, "shift": False, "properties": [("deselect", False)]},
                {'label': 'Select linked', 'keymap': 'Mesh', 'idname': 'mesh.select_linked', 'type': 'LEFTMOUSE', 'value': 'DOUBLE_CLICK', "alt": False, "ctrl": True, "shift": False, "properties": [("deselect", False)]}
        ]
}
